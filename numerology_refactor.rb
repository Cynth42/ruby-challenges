...
def user_life_path_num(birthdate)
...
def numerology_message(life_path_num)
    puts "Your numerology number is #{life_path_num}"
    case life_path_num
        when 1
        ...
        message = "Omg! Are you an alien from space?"
    end
end

puts "What is your birthdate? Please write it in MMDDYYYY format"
birthdate = gets.strip

life_path_num = user_life_path_num(birthdate)

message = numerology_message(life_path_num)
